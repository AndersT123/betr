...
config file holds users and passwords along with database credentials and scores api credentails and league configuration (which gameweeks are avaiable to the league).
